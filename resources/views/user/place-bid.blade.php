                                    ...
                                    <div class="product-item__body">
                                        ...
                                        <div class="product-item__content text-capitalize">
                                            ...
                                            <span class="product-desc-price">
                                                <sub></sub>KES {{ $car->min_price }}</span>
                                            <div class="d-flex align-items-center mb-2">
                                                <span class="product-price">{{ $bids }} Placed</span>
                                            ...
                                            <div class="product-item__button mt-lg-30 mt-sm-25 mt-20 d-flex flex-wrap">
                                                <div class=" d-flex flex-wrap product-item__action align-items-center">
                                                    ...
                                                    @if ($checkbid->count() > 0)
                                                        <button
                                                            class="btn btn-secondary btn-default btn-squared border-0 px-25 my-sm-0 my-4 mr-2">
                                                            <span data-feather="shopping-bag"></span>
                                                            You have already placed your bid on this car. Your can edit it
                                                            from here</button>
                                                    @else
                                                        <form action="{{  url('user/submit-bid') }}" method="POST">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" min="{{ $car->min_price }}"
                                                                            placeholder="{{ $car->min_price }}" required name="bid_amount"
                                                                            class="form-control">
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-lg-3 col-md-3 col-xs-12 col-sm-6">
                                                                    <button
                                                                        class="btn btn-secondary btn-default btn-squared border-0 px-25 my-sm-0 my-2 mr-2">
