...
! function(e) {
    ...
    function D() {
        "level-one" == this.dataset.drawer ? (w.classList.add("level-one"), w.classList.add("show"), w.classList.remove("level-two"), g.classList.add("show")) : "level-two" == this.dataset.drawer && (w.classList.add("level-two"), x.classList.add("show"), w.classList.add("show"))
    }
    ...
    })), T && T.forEach(e => e.addEventListener("click", D)), e(".atbd-upload-avatar").on("click", (function(t) {
    ...
    })), N && Y && (N.addEventListener("click", G), Y.addEventListener("click", G)), e(".search-toggle").on("click", (function(t) {
